...
namespace DevAssignment.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            _domainService = new AccountDomainService(new AccountDataRepository(AccountDbContext.Create("AccountDbHarbor")), new MappingEngine(new GenericMapperConfigurationProvider<AccountListMappingProfile>()));
        }
